...
function Factura(empresa, cliente, items, numFactura, tipoIVA, formaPago){
...
Factura.prototype.direcciontoString()
...
Factura.prototype.resumir = function () {
    ...
    this.calcularImporte().total

}

const Empresa = new Empresa('Bighit', 
        new direccion('c/ Bangtan', '7', 'Seul', 'Corea del Sur'), 
        '625872321', 
        'T-3476179834')
const Cliente1 = new Empresa('Army', 
        new direccion('c/ Fan de Bts', '35', 'Madrid', 'España'), 
        '625667881', 
        'T-347639454')
const Items = [
        new items('Lighstick con la forma del mundo', 80, 100),
        new items('Album Persona', 30, 500),
        new items('Camiseta con los dibujos de BT21', 40, 200)
] 
const Factura_59 = new factura(
        empresa, cliente1, items, '000000059',
        0.04, 'contado', new Date()
)

//factura_59.render()
console.log(Factura_59)
